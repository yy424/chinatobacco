...
<body>
	...
	<form class="form-horizontal from" style="margin: 0 auto;"
		action="repertory/update.do">
		<h1 style="text-align: center;">修改库存</h1>
		<div class="form-group d1">
			<label for="inputEmail3" class="col-sm-2 control-label">商品名称:</label>
			<div class="col-sm-10">
				<select class="form-control" name="comid" id="comid"></select> <input
		...
		<div class="form-group d1">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="inputEmail3" name="num"
					value="${num}">
			</div>
		</div>
		<div class="form-group d1">
			...
			<div class="col-sm-10">
				<select class="form-control" name="locid" id="locid"></select>
			</div>
		</div>
		<div class="form-group d1">
