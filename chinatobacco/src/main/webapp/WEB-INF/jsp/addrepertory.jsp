	...
	<center>
		...
		<form class="form-horizontal from" action="repertory/add.do">
			...
			<div class="form-group d1">
				...
				<div class="col-sm-10">
					<select class="form-control" name="comid" id="comid"><option>${repertory.commodity.comname }</option></select>
				</div>
			</div>
			<div class="form-group d1">
			...
			<div class="form-group d1">
				...
				<div class="col-sm-10">
					<select class="form-control" name="locid" id="locid"><option>${repertory.commodity.comname }</option></select>
				</div>
			</div>
			<div class="form-group d1">
